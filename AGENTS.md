...
## Overview
High performance Bun-native standard output JSON logger

## Isolation & Decoupling
This `AGENTS.md` is strictly specific to the `@ninots/logger` package.
...
- Treat `@ninots/logger` as an independent and isolated project.
